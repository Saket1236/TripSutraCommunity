...
import { MapPin, Upload, CheckCircle2, Loader2, Plus, Navigation, Link as LinkIcon, Globe, Map as MapIcon } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <Upload className="absolute right-4 top-3.5 text-gray-400" size={18} />
                </div>
              </div>
            </div>
          </div>
